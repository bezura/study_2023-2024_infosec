...
author: "Хрусталев Влад НПИбд-02-22"
...
5.	Уточнили имя пользователя, его группу, а также группы, куда входит пользователь, командой id. Выведенные значения uid, gid и др. Сравнили вывод id с выводом команды groups. Видим, что gid и группы
...
![Сожержимое файла /etc/passwd](image/image2.png){ #fig:002 width=70% height=70% }
![Расширенные атрибуты](image/image3.png){ #fig:003 width=70% height=70% }
...
![Расширенные атрибуты](image/image4.png){ #fig:004 width=70% height=70% }
![Расширенные атрибуты](image/image5.png){ #fig:005 width=70% height=70% }
...
![Снятие атрибутов с директории](image/image8.png){ #fig:008 width=70% height=70% }
![Снятие атрибутов с директории](image/image7.png){ #fig:007 width=70% height=70% }
![Снятие атрибутов с директории](image/image6.png){ #fig:006 width=70% height=70% }
